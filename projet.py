...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gausien5x5.setObjectName("gausien3x3")
        self.gausien7x7 = QtWidgets.QAction(MainWindow)
        self.gausien7x7.setObjectName("gausien5x5")
        ...
        self.menuGaussien.addAction(self.gausien7x7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gausien5x5.setText(_translate("MainWindow", "s = 0.1"))
        self.gausien7x7.setText(_translate("MainWindow", "s = 0.8"))
        ...
        self.gausien5x5.triggered.connect(self.gaussian5)
        self.gausien7x7.triggered.connect(self.gaussian7)
        ...
        self.actionhistogramme.triggered.connect(self.BinarisationOtsu)
        #self.redimentx2.triggered.connect(self.fredimentx2)
    ...
    def BinarisationOtsu(self):
        ...
        self.ImageFinale.setPixmap(QtGui.QPixmap(pixmap4))
        self.ImageFinale.adjustSize()
        self.label_2.setText("L\'image resultat :histogramme")
        self.label_2.adjustSize()
